                ...
                <Orientation orientation='landscape' alwaysRender={false}>
                    <DragDropContext onDragEnd={this.onDragEnd}>
                        <div className='bg-violet-500 min-h-screen px-4 md:px-8 xl:px-28 pt-4 p-4'>
                            ...
                            <h1 className='text-white mb-2'>1. Lengkapi kotak dibawah dengan huruf hijaiyah : <b>Ba Ta Ta</b></h1>
                            ...
                            <Transition appear show={this.state.modal} as={Fragment}>
                                ...
                                >
                                    <div className="min-h-screen px-4 text-center">
                                        ...
                                        >
                                            <div className="inline-block w-full max-w-sm my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl py-10">
