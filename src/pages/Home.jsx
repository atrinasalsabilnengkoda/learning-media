...
export default function Home() {
    ...
    return (
        <div className='bg-violet-500 min-h-screen flex flex-col items-center justify-center'>
            ...
            <button onClick={() => navigate('/profil')} className='flex items-center bg-custom-coral shadow-notclick text-white text-xl py-2 px-4 rounded-full mb-3 hover:bg-white hover:text-custom-coral'><UserIcon className='w-6 h-6 mr-2 ' />Profil</button>
